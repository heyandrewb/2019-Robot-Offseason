...
public class Robot extends TimedRobot {
  ...
  Talon m_armRaise;
  Talon m_armLower;
  Talon m_lowerIntakeRoller;

  CANSparkMax m_topIntakeRoller;

  // Create Sub System Pneumatics
  Solenoid m_hatcherExtend;
  Solenoid m_hatcherGrab;

  DoubleSolenoid m_rearClimb;
  ...
  static NetworkTableEntry networkTableEntryFrontLeftSpeed = SwerveTab.add("FL Speed", 0)
      ...
      .withProperties(Map.of("Min", 0, "Max", 1, "Center", 0, "Orientation", "VERTICAL")).withPosition(1, 0)
      .withSize(2, 5).getEntry();

  static NetworkTableEntry networkTableEntryFrontRightSpeed = SwerveTab.add("FR Speed", 0)
      .withWidget(BuiltInWidgets.kVoltageView)
      .withProperties(Map.of("Min", 0, "Max", 1, "Center", 0, "Orientation", "VERTICAL")).withPosition(14, 0)
      .withSize(2, 5).getEntry();

  static NetworkTableEntry networkTableEntryBackLeftSpeed = SwerveTab.add("BL Speed", 0)
      .withWidget(BuiltInWidgets.kVoltageView)
      .withProperties(Map.of("Min", 0, "Max", 1, "Center", 0, "Orientation", "VERTICAL")).withPosition(1, 5)
      .withSize(2, 5).getEntry();

  static NetworkTableEntry networkTableEntryBackRightSpeed = SwerveTab.add("BR Speed", 0)
      .withWidget(BuiltInWidgets.kVoltageView)
      .withProperties(Map.of("Min", 0, "Max", 1, "Center", 0, "Orientation", "VERTICAL")).withPosition(14, 5)
      .withSize(2, 5).getEntry();
  ...
  static NetworkTableEntry frontLeftEncoderDifference = SwerveEncoders.add("FL Encoder Difference", 0)
      .withWidget(BuiltInWidgets.kTextView).withPosition(10, 0).withSize(2, 1).getEntry();

  static NetworkTableEntry frontRightEncoderDifference = SwerveEncoders.add("FR Encoder Difference", 0)
      .withWidget(BuiltInWidgets.kTextView).withPosition(12, 0).withSize(2, 1).getEntry();

  static NetworkTableEntry backLeftEncoderDifference = SwerveEncoders.add("BL Encoder Difference", 0)
      .withWidget(BuiltInWidgets.kTextView).withPosition(10, 1).withSize(2, 1).getEntry();

  static NetworkTableEntry backRightEncoderDifference = SwerveEncoders.add("BR Encoder Difference", 0)
      .withWidget(BuiltInWidgets.kTextView).withPosition(12, 1).withSize(2, 1).getEntry();
  ...
  static NetworkTableEntry frontRightAngle = SwerveEncoders.add("FR Angle", 0).withWidget(BuiltInWidgets.kTextView)
  ...
  static NetworkTableEntry backLeft360Angle = SwerveEncoders.add("BL 360 Angle", 0).withWidget(BuiltInWidgets.kTextView)
  ...
  static NetworkTableEntry shuffleboardGyroYaw = SubSystems.add("Gyro - Yaw", 0).withWidget(BuiltInWidgets.kTextView)
      .getEntry();
  static NetworkTableEntry shuffleboardGyroCompass = SubSystems.add("Gyro - Compass Heading", 0)
  ...
  public void robotInit() {
    ...
    SwerveTab.add("Front Left Swerve Angle Gyro", frontLeftGyroAdapter).withProperties(Map.of("Starting angle", 0))
        .withPosition(3, 0).withSize(5, 5);
    SwerveTab.add("Front Right Swerve Angle Gyro", frontRightGyroAdapter).withProperties(Map.of("Starting angle", 0))
        .withPosition(9, 0).withSize(5, 5);
    SwerveTab.add("Back Left Swerve Angle Gyro", backLeftGyroAdapter).withProperties(Map.of("Starting angle", 0))
  ...
  public void robotPeriodic() {
    ...
    frontLeftEncoderDifference
        .setDouble(m_FrontLeftSteering.getSelectedSensorPosition() - m_drive.frontLeftTargetPosition);
    frontRightEncoderDifference
        .setDouble(m_FrontRightSteering.getSelectedSensorPosition() - m_drive.frontRightTargetPosition);
    backLeftEncoderDifference
        .setDouble(m_BackLeftSteering.getSelectedSensorPosition() - m_drive.backLeftTargetPosition);
    backRightEncoderDifference
        .setDouble(m_BackRightSteering.getSelectedSensorPosition() - m_drive.backRightTargetPosition);
  ...
  public void teleopPeriodic() {
    ...
    if(m_gamepad.getRawButtonReleased(5)) //TODO: Fix the button number
    {
        ...
        { m_SubSystems.subsystemsStateManager("hatchIntake", "Extend"); }
    }
